  ...
  <div class="private">
    <div class="container-fluid">
      <div class="row bg-ligth">
        <div class="col-lg-12">
          <p class="p">Política de Privacidade</p>
          <hr class="bg-info" />
        </div>
        <div class="row">
          <div class="col-sm-12">
            <div class="privacidade">
              ...
              <p>
                A sua privacidade é importante para nós. É política do AdonaiSoft respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site
                <a href="adonaisoft.com.br">AdonaiSoft</a>, e outros sites que possuímos e operamos.
              </p>
              ...
              <h2>Política de Cookies AdonaiSoft</h2>
