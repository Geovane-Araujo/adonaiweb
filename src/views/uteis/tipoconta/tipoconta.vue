<template>
  <div class="membro">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-lg-12" style="margin-top: -30px;">
          ...
          :flex="[{ tamanho: 10, name: 'id' }, { tamanho: 180, name: 'descricao' }, { tamanho: 20, name: 'contexto' }]"
    ...
    <Dialog style="font-size:10px;" header="Cadastro tipos Contas" :visible.sync="openModal" :style="{width: '30vw'}" :modal="true">
      <div class="col-sm-12">
        <input type="text"
        name="descricao"
        autocomplete="off"
